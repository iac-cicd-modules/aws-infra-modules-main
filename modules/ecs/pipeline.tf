...
resource "aws_iam_role" "codepipeline_role" {
  count = var.setup_pipeline ? 1 : 0
  name  = "codepipeline-${var.name}-${var.environment}"
...
resource "aws_iam_role_policy_attachment" "codestare_role_attachment" {
  count      = var.setup_pipeline ? 1 : 0
    ...
    action {
      ...
      configuration = {
        ...
        EnvironmentVariables = jsonencode([
          {
            name  = "DOCKER_PATH"
            value = var.docker_path
          },
          {
            name  = "IMAGE_REPO_NAME"
            value = var.existing_container_registry ? var.image_uri : aws_ecr_repository.main[0].name
          },
          {
            name  = "CONTAINER_NAME"
            value = var.name
