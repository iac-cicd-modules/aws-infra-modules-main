...
# Role/Policy/Attachment for AWS Load Balancer Controller
#####

resource "aws_iam_role" "aws_eks_lbc_role" {
  
    name = "${var.name}-EKSLoadBalancerController"
...
resource "aws_iam_role_policy_attachment" "lbc_role_policy_attach" {
    role       = aws_iam_role.aws_eks_lbc_role.name
